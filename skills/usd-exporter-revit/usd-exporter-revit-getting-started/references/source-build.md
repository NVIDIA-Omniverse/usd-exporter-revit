...
Solutions: `source/solutions/UsdExporterRevit<ver>.sln`  
...
After a release build, run the generated setup executable for the matching Revit version from the build output, accept the UAC prompt, then relaunch Revit and confirm the USD Exporter ribbon commands appear.
