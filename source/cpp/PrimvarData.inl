...
template <typename T>
PrimvarData<T>::PrimvarData(const pxr::TfToken& interpolation, const pxr::VtArray<T>& values, int elementSize) : m_interpolation(interpolation), m_elementSize(elementSize), m_values(values)
{
}

template <typename T>
PrimvarData<T>::PrimvarData(const pxr::TfToken& interpolation, const pxr::VtArray<T>& values, const pxr::VtArray<int>& indices, int elementSize) : m_interpolation(interpolation), m_elementSize(elementSize), m_values(values), m_indices(indices)
{
}
...
{
    return ((m_interpolation == other.interpolation()) && (m_elementSize == other.elementSize()) && (this->hasIndices() == other.hasIndices()) && m_values.IsIdentical(other.values()) && m_indices.IsIdentical(other.indices()));
}
...
{
    return ((m_interpolation == other.interpolation()) && (m_elementSize == other.elementSize()) && (this->hasIndices() == other.hasIndices()) && (m_values == other.values()) && (m_indices == other.indices()));
}
