...
{
    [DllImport("revit_usd_export", EntryPoint = "pxr_usd_defineCylinderLight", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
...
{
    [DllImport("revit_usd_export", EntryPoint = "pxr_usd_defineDiskLight", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
...
{
    [DllImport("revit_usd_export", EntryPoint = "pxr_usd_defineSphereLight", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
...
{
    [DllImport("revit_usd_export", EntryPoint = "pxr_usd_createLuxShapingApiIesFileAttr", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("revit_usd_export", EntryPoint = "pxr_usd_createLuxShapingApiIesFileAttrAtTime", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
