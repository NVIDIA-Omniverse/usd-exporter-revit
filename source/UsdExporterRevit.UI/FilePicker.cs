...
public static class FilePicker
{
    ...
    {
        string returnFolder = UsdExporterRevitBrowser.usd_export_browser.BrowseDlg(true, false, title, buttonLabel, defaultUri, false);
    ...
    {
        string uri = UsdExporterRevitBrowser.usd_export_browser.BrowseDlg(false, true, title, buttonLabel, defaultUri, false);
        return uri.Replace("%20", " ");
    }

    public static string SaveJsonUri(string title, string buttonLabel, string defaultUri = "")
    {
        string uri = UsdExporterRevitBrowser.usd_export_browser.BrowseDlg(false, false, title, buttonLabel, defaultUri, true);
        return uri.Replace("%20", " ");
    }
}
}
