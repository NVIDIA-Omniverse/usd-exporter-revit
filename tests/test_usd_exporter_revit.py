...
class TestUsdExporterRevit(unittest.TestCase):
    def setUp(self):
    ...
    def test_generic(self):
        ...
        if self.__class__ is TestUsdExporterRevit:
            self.skipTest("Only derived classes of TestUsdExporterRevit should run this test.")
        self._setup_exe = _resolve_build_path(f"UsdExporterRevitSetup{self._ver}.exe")
